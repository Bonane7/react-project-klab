...
import { FiPlus, FiSearch, FiEdit2, FiTrash2, FiX, FiImage, FiAlertCircle, FiCheckCircle, FiLoader, FiPackage } from "react-icons/fi";
...
function Products() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      closeModal();
      fetchProducts(); // ✅ Recharge les produits pour mettre à jour le compteur
    } catch (err) {
      setFormError(
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ✅ HEADER AVEC TOTAL PRODUCTS */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold text-gray-800">Products</h2>
            <span className="bg-orange-100 text-orange-600 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1.5">
      ...
      {showDeleteConfirm && productToDelete && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999] p-4 animate-[fadeIn_.2s_ease]">
          <div className="bg-white rounded-2xl p-6 max-sm:w-full shadow-2xl">
