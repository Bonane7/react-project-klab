...
import { FiArrowRight, FiStar, FiHeart, FiTruck, FiShield, FiClock, FiHeadphones, FiChevronLeft, FiChevronRight, FiShoppingBag } from "react-icons/fi";
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Over FRW 200</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm">
          ...
          {productsLoading ? (
            ...
            recommendedProducts.map((product, index) => {
              ...
              return (
                <div 
                  key={productId} 
                  className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all relative"
                >
                  <Link to={`/user/product/${productId}`} className="block">
                    ...
                    <div className="p-3 lg:p-4">
                      ...
                      <p className="text-orange-500 font-bold mt-1">FRW {Number(productPrice).toFixed(2)}</p>
                    </div>
                  </Link>
